...
public class SubscriberArticleManagerImpl implements SubscriberArticleManager
{
  ...
  private IDao              suggestedArticleDao;
  private RepositoryManager               repositoryManager;

  public SubscriberArticleManagerImpl(IDao suggestedArticleDao,
  ...
  public List<SuggestedArticle> getArticlesbySubscriber(Integer subscriberId)
  {
    ...
    criteria.setOrderByClause("create_time desc"); //run time dependency
